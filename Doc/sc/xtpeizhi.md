 ...
 */
return [
    'Timezone'  => 'PRC',    // 默认时区,PRC是中国
    'Charset'   => 'utf-8',    // 编码 utf-8|RPC
     ...
     * 文件里面可以使用$msg变量获取出错提示内容
     */
//  'error_page_db' => 'application/error/error_db.php',        //todo
...
//        'View_File_Subfix'          => '.view.php',     //视图文件名称后缀,比如.view.php
    ...
    'Server'=>[
        ...
        'ProvidersConfig'  => [
             ...
             */
            'Log'       => [
                'path'=> GRACE.'../App/Cache/Log/dt.log'                //日志文件 文件地址
            ],
            ...
            /**
             * Cache相关配置
             * 注意 ： \Desarrolla2\Cache\ 中 Adapter\Memcache 经过修改，请不要用原来的文件
             */
            'Cache'     => [
                /**
                 * File cache
...
//                ],
        ...
        //容器对象
        'Providers'=>[
            'Parsedown' => Grace\Parsedown\Parsedown::class,        //Markdown文件解析
            'Req'       => Grace\Req\Req::class,                    //输入数据获取
            'Db'        => Grace\Db\Db::class,                      //Mysql数据库访问对象
            'Cookies'   => Grace\Cookies\Cookies::class,            //Cookies
            'Cache'     => Grace\Cache\Cache::class,                //缓存访问对象
            'Mmc'       => Grace\Mmc\Mmc::class,                    //Memcache访问对象
//            'Xls'       => Grace\Xls\Xls::class,                  //对Excel文件进行解析的对象
//            'Smarty'    => Grace\Smarty\Smarty::class,            //Smarty前端模板
//            'View'      => Grace\View\View::class,                //前端视图
            'Log'       => Grace\Log\Log::class,                    //日志访问对象
        ],
    ]
];
```
